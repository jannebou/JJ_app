...
/** @type {string} */
const CACHE_VERSION = '1781015401|1998814026';
/** @type {string} */
const CACHE_PREFIX = 'jj-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'jj.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["jj.html","jj.js","jj.offline.html","jj.icon.png","jj.apple-touch-icon.png","jj.audio.worklet.js","jj.audio.position.worklet.js","pako_inflate.min.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["jj.wasm","jj.pck"];
